    ...
    <section className="relative h-[600px] lg:h-[700px] overflow-hidden hero bg-no-repeat bg-cover container mx-auto px-4 max-w-screen-xl flex lg:items-center">
      <div className="flex flex-col gap-8 w-full lg:w-[60%]">
        ...
        <p className="font-semibold text-lg sm:text-2xl z-10" data-aos="fade-up">
          Activating P2P Marketplace on your Pi wallet allows you to securely
        ...
        <div className="z-10">
          <Link to={'/validate'}><button className="border-2 group transition-colors duration-300 hover:text-white hover:bg-secondary flex items-center gap-4 border-secondary text-secondary bg-transparent px-10 py-4 lg:text-lg text-sm rounded-md font-semibold">
